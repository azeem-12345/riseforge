  ...
  return (
    <GameShell>
      <div className="space-y-6 md:space-y-8 pb-20 px-3 md:px-4 max-w-7xl mx-auto">
        ...
        {/* 8th-Grade Welcome Guidance Banner - Animated */}
        <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <CardContent className="py-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {skillData.map((skill) => {
                      ...
                      return (
                        <div key={skill.name} className="space-y-2 p-4 bg-secondary/30 border border-border/60 rounded-xl hover:bg-secondary/40 transition-colors">
                          <div className="flex justify-between items-center text-sm">
                            <div>
                              <span className="font-semibold text-foreground font-sans">{skill.name}</span>
                      ...
                      <div key={index} className="flex gap-5 relative items-start text-sm">
                        ...
                        <div className="space-y-1 flex-1 min-w-0 pt-1">
                          <div className="flex justify-between items-start gap-2">
                            ...
                            <span className="font-mono text-xs font-semibold text-emerald-600 bg-emerald-600/10 px-2 py-0.5 rounded-md flex-shrink-0">
                              {event.xp}
                            </span>
                          </div>
          ...
          <div className="space-y-6">
                ...
                <CardContent className="space-y-2.5">
                  <Button asChild className="w-full justify-between h-12 text-sm font-medium bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_15px_rgba(var(--primary)/0.3)] transition-all px-4 rounded-xl">
                    <Link href="/world-map" className="flex items-center justify-between w-full">
                      <span className="font-sans">Resume Startup Path</span>
                  ...
                  <Button asChild variant="outline" className="w-full justify-between h-12 text-sm font-medium border-border bg-secondary/50 hover:bg-secondary text-foreground transition-colors px-4 rounded-xl">
                    <Link href="/leaderboard" className="flex items-center justify-between w-full">
                      <span className="font-sans">View Leaderboard</span>
            ...
            {/* My Course Goals (Purely Educational) */}
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              <Card className="glass-card shadow-sm">
                <CardHeader className="pb-4">
